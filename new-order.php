  ...
  position: absolute;
    ...
    font-family: arial;
                    ...
                    <div id="new-order-body">
                      ...
                      $selectuniqueorder=mysqli_query($con,"select DISTINCT orderid from itemorder where status='1' ORDER BY ID DESC");
                      $new_order=mysqli_num_rows($selectuniqueorder);

                       ?>
                      <span style="font-size:25px;padding:3%;">New Orders(<?php echo $new_order; ?>)</span>
                      ...
                      <BR><div id="view-more-details-body">
                        <div id="item-status" style="color:green;text-align:center;">
                          ...
                          <center>
                            ...
                            <a href='admin-item-details.php?orderid=<?php echo$orderid; ?>'>
