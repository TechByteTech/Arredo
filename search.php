...
$(document).ready(function(){
    ...
    $("#search-input").on('input',function(){
      ...
      $("#result-of-search-by-name").html("<center>  <div class='spinner-border' style='margin-top:8px;margin-bottom:8px;' ></div></center>");
        ...
        success:function(data,textStatus){
          ...
          if(data!=0){
            ...
            while(i<arr.length)
            {
                ...
                $("#result-of-search-by-name").append(`<a href='profile.php?userid=${arr[i][0]}' style='text-decoration:none;color:black;'><div id='result' style='margin-left:10px;height:40px;'>
                  <div id='result-image' style='width:50px;height:50px;float:left;margin-right:10px;'><img src='photos/${arr[i][1]}' style="width:50px;height:50px;border-radius:50%;object-fit:contain;"></div>
                    ...
                    <div id='result-branch' style='width:30%;float:left;'>₹${arr[i][3]}</div>
