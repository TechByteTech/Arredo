  ...
  position: absolute;
    ...
    font-family: arial;
                    ...
                    <div id="new-order-body">
                      ...
                      $selectitemorder=mysqli_query($con,"select * from userdata");
                      $total_customer=mysqli_num_rows($selectitemorder);
                       ?>
                       <div style="width:100%;margin:auto;">
                      <span style="font-size:20px;padding:3%;width:80%;">Customer(<?php echo $total_customer; ?>)</span>
                    </div>
                      <?php
                      ...
                      $i=0;
                       ...
                       while($itemorderdata=mysqli_fetch_array($selectitemorder)){
                        $person_name=$itemorderdata['username'];
                        $person_email=$itemorderdata['email'];
                  ...
                  //      $fetchselectitem=mysqli_fetch_array($selectitem);
                    ...
                    //    $qty=$itemorderdata['itemquantity'];
                        ...
                        ?>
                          <div id="item-details-body" style="width: 90%;
    padding: 25px;
    height: 135px;">
                      ...
                      <div id="item-image-and-pricing">
                        <div id="item-image-block">
                         <div id="item-image-box">
                           <img src="compressed-photos/person01.png"  id="item-image"  >
                         </div>
                        </div>
                         ...
                         <div id="item-description-box">
                           <div id="item-description">
                             <?php echo $person_email;?>
                              ...
                              <BR><div id="view-more-details-body" style="display:none;">
