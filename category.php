...
<br><br><br><br>
 ...
 <div id="trending-item-body">
   ...
   <center><div style="font-size:55px;padding:10px;text-transform:uppercase;font-family:none;"><?php echo $category_name; ?></div></center>
   <center>
   ...
   <?php
     ...
     $select_shopItem=mysqli_query($con,"select * from shopitem where itemcategory='$category_name' order by rand()");
