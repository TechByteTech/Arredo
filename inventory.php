    ...
    font-family: arial;
                    ...
                    <center>  <span style="font-size:25px;padding:3%;">INVENTORY</span></center><br>
                      ...
                      $con=new mysqli("localhost","root","","arredo");
                       ...
                       ?>
                      <span style="font-size:20px;padding:3%;">All Item(100)</span>

                      <?php

                      $i=0;

                        $selectitemorder=mysqli_query($con,"select * from shopitem ORDER BY ID DESC");
                       ...
                       while($itemorderdata=mysqli_fetch_array($selectitemorder)){
                        ...
                        $item_name=$itemorderdata['itemname'];
                        $item_desc=$itemorderdata['itemdescription'];
                        $itemprice=$itemorderdata['itemprice'];
