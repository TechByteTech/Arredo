...
use bvpconnects\Microsoft\Auth;
...
$callback_url = "https://jodi.bvpconnects.com/callback.php";
...
use bvpconnects\Microsoft\Auth;
use bvpconnects\Microsoft\Handlers\Session;
...
```php
use bvpconnects\Microsoft\Models\User;
